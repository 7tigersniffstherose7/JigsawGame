...
public class LoginJFrame extends JFrame implements MouseListener {
    ...
    static ArrayList<com.game.User> allUsers = new ArrayList<>();
    ...
    public void mousePressed(MouseEvent e) {
        if (e.getSource() == login) {
            login.setIcon(new ImageIcon("image\\image\\login\\登录按下.png"));
        } else if (e.getSource() == register) {
            register.setIcon(new ImageIcon("image\\image\\login\\注册按下.png"));
        }
    }
    ...
    //判断用户在集合中是否存在
    public boolean contains(com.game.User userInput) {
        for (int i = 0; i < allUsers.size(); i++) {
            com.game.User rightUser = allUsers.get(i);
